...
import akoniImage from "../img/lynseant-removebg-preview.png";
import ibisImage from "../img/ibis-paint-x.png";
import vscodeImage from "../img/vc-code.png";
import gcbImage from "../img/gcb.png";
import warcraftImage from "../img/tianson.jpg";
import generalImage from "../img/seant.jpg";
import battleImage from "../img/tian.jpg";
                  ...
                  <div className="col-lg-6 ok">
                    <div className="card">
                      ...
                      <p className="self text-light">
                        I love Eating and i love dance 
                      </p>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <h3 className="display-3">
              Recent <br /> Sexy Chubby Girls
            </h3>
            <div className="col-lg-7 align-items-center">
              <div className="card">
                <h4 className="ms-3 mt-3">1. Hottie</h4>
                <img src={warcraftImage} alt="" />
              </div>
              <div className="card">
                <h4 className="ms-3 mt-3">2. Sexy Chubby</h4>
